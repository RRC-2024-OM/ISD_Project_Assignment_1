...
class AccountDetailsWindow(DetailsWindow):
    ...
    Attributes:
        balance_updated (Signal): A signal emitted when the balance is updated, carrying a BankAccount object.
    """
    balance_updated = Signal(BankAccount)  # Define the signal
    ...
    def __init__(self, account: BankAccount) -> None:
        ...
        Args:
            account (BankAccount): The bank account to be displayed and modified.
    ...
    def __on_apply_transaction(self) -> None:
        """
        Applies a transaction (deposit or withdraw) to the account.
        
        Emits:
            balance_updated (Signal): Emitted after a successful transaction.
